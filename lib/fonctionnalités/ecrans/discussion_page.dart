...
class DiscussionPage extends StatefulWidget {
  ...
  const DiscussionPage({Key? key, required this.discussion}) : super(key: key);
...
class _DiscussionPageState extends State<DiscussionPage> {
  ...
  Widget _buildMessageBubble(ChatMessage message) {
    ...
    return Align(
      ...
      child: Container(
        constraints: BoxConstraints(maxWidth: MediaQuery.of(context).size.width * 0.75), // Limite la largeur du message
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.discussion.title, style: KTypography.h4(context, color: Colors.white)),
